...
// Extra styles
function newsbuzz_customizer_stylesheet() {
	
	// Stylesheet
	wp_enqueue_style( 'newsbuzz-customizer-css', get_template_directory_uri().'/css/customizer-styles.css', NULL, NULL, 'all' );
...
// Need some help?
	...
	$wp_customize->add_setting('newsbuzz_options[info]', array(
		'sanitize_callback' => 'newsbuzz_no_sanitize',
		'type' => 'info_control',
		'capability' => 'edit_theme_options',
		)
	);
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'pro_section', array(
		'section' => 'newsbuzz_new',
		'settings' => 'newsbuzz_options[info]',
		'type' => 'textarea',
		'priority' => 109
		) )
	);   
	...
	$wp_customize->add_section(
		'newsbuzz_premium',
		array(
			'title' => __('NewsBuzz Premium', 'newsbuzz'),
			'priority' => 9999,
			'description' => __('
		<p>
				<a style="display:block;" href="http://vilhodesign.com/themes/newsbuzz/" target="_blank">
	...
	$wp_customize->add_setting('newsbuzz_premium[info]', array(
		'sanitize_callback' => 'newsbuzz_no_sanitize',
		'type' => 'info_control',
		'capability' => 'edit_theme_options',
		)
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'premium_section', array(
		'section' => 'newsbuzz_premium',
		'settings' => 'newsbuzz_premium[info]',
		'type' => 'textarea',
		'priority' => 109
		) )
	);   
...
if(! function_exists('newsbuzz_header_bg_color_css' ) ):
/**
* Set the header background color 
*/
function newsbuzz_header_bg_color_css(){
	...
	<?php }
	add_action( 'wp_head', 'newsbuzz_header_bg_color_css' );
	endif;
